...
class word_guess:
    ...
    def calc_word(self):
        ...
        for index in range(int(self.name_length)):
            final += self.matrix[int(self.transpose_columns_selected[index])-1][int(self.columns_selected[index])-1]
        return final
...
class Game:
    def __init__(self):
        ...
        self.background = pygame.image.load_extended("sprites/bg.jpg").convert_alpha()
        self.anya_sprites = [pygame.transform.scale(pygame.image.load_extended("sprites/anya/"+img).convert_alpha(),(400,300)) for img in os.listdir("sprites/anya")]
